...
With my experience in applying security fundamentals to hardware and software setup/installation/configuration/troubleshooting, I am seeking opportunities that would allow me to work with a variety of technologies. Especially Cloud and Security Technologies.

# 👨‍💻 Information Technology Projects 👨‍💻

## [-- Azure Vulnerability Management with OpenVAS --](https://github.com/whuynhit/OpenVas/blob/main/README.md)

## [-- Azure Sentinel Lab -- In Progress...](https://github.com/whuynhit/Sentinel/blob/main/README.md)
